...
![](img/fixed.jpg){height=450px fig-align='center'}    
...
<!-- ## Statistical Terminology Is Awful -->

<!-- <br> -->

<!-- - contradict standard english (*significance*) -->
<!-- - jargon (*heteroskedasticity*) -->
<!-- - often ambiguous (*fixed & random effects*) -->

<!-- -------------------------------------------------------------------- -->

<!-- ## Five Definitions of Random Effects -->
...
<!--  - When a sample exhausts the population, the corresponding variable is fixed; when the sample is a small (negligible) part of the population the corresponding variable is random. -->

<!-- -------------------------------------------------------------------- -->

<!-- ## Five Definitions of Random Effects (con't) -->

<!-- <br> -->

<!-- - If an effect is assumed to be a realized value of a random variable, it is called a random effect. -->
<!-- - Fixed effects are estimated using maximum likelihood and random effects are estimated with shrinkage. -->


<!-- -------------------------------------------------------------------- -->

<!-- ## Disclaimer: "Fixed vs. Random Effects" -->

<!-- - **No formal definition exists.** -->
<!-- - 5+ definitions exist for "random effects"... -->
<!-- - Communicate how analysis was performed: share code & data. -->
...
<!--  - use the first definition of random effects...  -->
